...
public class Chaining {
    ...
    public int chain (int key) {
        // hash value calculated from parameter key
    ...
    public int insertKey(int key){
    		...
    		ArrayList<Integer> firstSlot = this.Table.get(hashValue);
    		
    		if (!firstSlot.isEmpty())
    		{
    			//collision, go down the linked list
    			collisionCounter = firstSlot.size();
    			firstSlot.add(key);
    		}
    		else
    		{
    			// no collision, insert key
